...
- Audit every run with a templated, human-readable solution log
- Works in both Node.js and browser environments as a Fable service

[GitHub](https://github.com/stevenvelozo/elucidator)
[Get Started](#elucidator)
